...
今天選 Codex，是因為我們要用桌面介面開啟專案、修改檔案、預覽網站並做 build。這不代表 Codex 永遠最好；工具是否適合，要看任務、操作介面、資料位置與維護成本。

> Agent 多不等於比較厲害。只有工作真的能拆成多個獨立角色時，多 Agent 才有價值。
